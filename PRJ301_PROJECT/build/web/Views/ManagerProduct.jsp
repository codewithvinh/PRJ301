...
<!--                                                <a class="dropdown-item" href="#">My Profile</a>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <a href="#addModal" class="btn btn-info add-new" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="table-scroll">
                        <table class="table table-bordered">
                            <c:forEach items="${dao.columnName}" var="p">
                                <th style="width: auto;">${p}</th>
                                </c:forEach>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="word-wrap: break-word;">${p.productID}</td>
                                        ...
                                        <td style="word-wrap: break-word;">${p.discount}</td>
                                        ...
                                        <td>
                                            <a href='Edit?type=0&pid=${p.productID}'>Edit</a>
                                        </td>
                                        <td>
                                            <a href='Delete?type=1&pid=${p.productID}' onclick="doDelete('${p.productID}')">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </c:forEach>
                        ...
                        <div class="button-paging">
                            <c:if test = '${index!=1}'>
                                <span class='button'><a href='ManagerProduct?index=1'>Home</a></span>
                                <span class='button'><a href='ManagerProduct?index=${index-1}'>Pre</a></span>
                            </c:if>
                            <c:forEach var="i" begin="${1}" end="${endPage}">
                                <span class="button${i == index ? ' active' : ''}">
                                    <a href="ManagerProduct?index=${i}">${i}</a>
                                </span>
                            </c:forEach>

                            <c:if test = '${index<endPage}'>
                                <span class='button'><a href='ManagerProduct?index=${index+1}'>Next</a></span>
                                <span class='button'><a href='ManagerProduct?index=${endPage}'>End</a></span>
                            </c:if>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="discount" type="text" class="form-control" 
                                           onblur="formatFloat('discount')">
                                    <span id="error-message-discount" style="color: red; display: none; font-size: 15px;">Vui lòng nhập đúng định dạng</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Upload image</td>
        ...
        <script>
            ...
            function doDelete(id) {
                if (confirm("Do you want delete productID = " + id)) {
